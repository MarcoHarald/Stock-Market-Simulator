...
#
plt.scatter(t0, yAxis0, c='red')
plt.scatter(t1, yAxis1, c='yellow')
plt.scatter(t2, yAxis2, c='green')
plt.scatter(t3, yAxis3, c='blue')
plt.scatter(t4, yAxis4, c='black')

#plt.imshow(t, yAxis0, cmap='hot', interpolation='nearest')

plt.legend(loc='upper left')
plt.ylabel('Return per day ($/day)', fontsize=10)
plt.xlabel('Investment Length (days)', fontsize=10)
plt.title('Evaluating Investment time period with MA method')
plt.show()
...
plt.xlabel('Investment Time Period (days)', fontsize=10)
plt.show()
...
plt.legend(loc='upper left')
plt.ylabel('Moving Average Score', fontsize=10)
plt.xlabel('Investment Time Period (days)', fontsize=10)
plt.show()
